...
const Header = () => {
  ...
  return (
    <>
      ...
      {isMenuOpen && (
        <>
          <div className="fixed inset-0 z-40 md:hidden" onClick={() => setIsMenuOpen(false)}></div>
          <div className="md:hidden fixed top-16 left-0 w-full bg-background z-50 pt-4 pb-2 shadow-lg backdrop-blur-sm">
